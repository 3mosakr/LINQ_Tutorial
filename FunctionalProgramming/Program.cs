...
namespace FunctionalProgramming
{
    internal class Program
    {
        ...
        private static void RunExtensionFunctional02()
        {
            ...
            var q6 = list.Filter(e => e.HasPensionPlan == true);
            q6.Print( "Employees with Pension Plan");

            var q7 = list.Filter(e => e.HasHealthInsurance == false);
            q7.Print( "Employees without Health insurance");

            var q8 = list.Filter(e => e.Salary == 103200);
        ...
        private static void RunExtensionFunctional01()
        {
            ...
            var q6 = ExtensionFunctional01.Filter(list, e => e.HasPensionPlan == true);
            ExtensionFunctional01.Print(q6, "Employees with Pension Plan");

            var q7 = ExtensionFunctional01.Filter(list, e => e.HasHealthInsurance == false);
            ExtensionFunctional01.Print(q7, "Employees without Health insurance");

            var q8 = ExtensionFunctional01.Filter(list, e => e.Salary == 103200);
